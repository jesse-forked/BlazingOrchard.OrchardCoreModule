...
public sealed class ResourceManagementOptionsConfiguration : IConfigureOptions<ResourceManagementOptions>
{
    ...
    static ResourceManagementOptionsConfiguration()
    {
        ...
        _manifest
                .DefineScript("BlazingOrchard.Site-vendor-jQuery")
                .SetUrl("~/BlazingOrchard.Site/vendor/jquery/jquery.min.js", "~/BlazingOrchard.Site/vendor/jquery/jquery.js")
        ...
        _manifest
                .DefineScript("BlazingOrchard.Site-vendor-jQuery.slim")
                .SetUrl("~/BlazingOrchard.Site/vendor/jquery/jquery.slim.min.js", "~/BlazingOrchard.Site/vendor/jquery/jquery.slim.js")
        ...
        _manifest
                .DefineScript("BlazingOrchard.Site-vendor-bootstrap")
                .SetDependencies("BlazingOrchard.Site-vendor-jQuery")
                .SetUrl("~/BlazingOrchard.Site/vendor/bootstrap/js/bootstrap.min.js", "~/BlazingOrchard.Site/vendor/bootstrap/js/bootstrap.js")
        ...
        _manifest
                .DefineScript("BlazingOrchard.Site-vendor-bootstrap-bundle")
                .SetDependencies("BlazingOrchard.Site-vendor-jQuery")
                .SetUrl("~/BlazingOrchard.Site/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/BlazingOrchard.Site/vendor/bootstrap/js/bootstrap.bundle.js")
        ...
        _manifest
                .DefineStyle("BlazingOrchard.Site-vendor-bootstrap")
                .SetUrl("~/BlazingOrchard.Site/vendor/bootstrap/css/bootstrap.min.css", "~/BlazingOrchard.Site/vendor/bootstrap/css/bootstrap.css")
        ...
        _manifest
                .DefineStyle("BlazingOrchard.Site-bootstrap-oc")
                .SetUrl("~/BlazingOrchard.Site/css/bootstrap-oc.min.css", "~/BlazingOrchard.Site/css/bootstrap-oc.css")
                .SetVersion("1.0.0");

        _manifest
                .DefineStyle("BlazingOrchard.Site-vendor-font-awesome")
                .SetUrl("~/BlazingOrchard.Site/vendor/fontawesome-free/css/all.min.css", "~/BlazingOrchard.Site/vendor/fontawesome-free/css/all.css")
        ...
        _manifest
                .DefineScript("BlazingOrchard.Site-vendor-font-awesome")
